...
import { FormField, Loader, Done } from '../components'
    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        <h1 className='font-extrabold text-[32px] text-[#e9eeff]'>
          Let The AI Create Your Images!
        </h1>
        <p className='mt-2 text-[#dee6ff] text-[16px] max-w-[500px]'>
          Create An Automatic AI Image Generator using DALL-E AI from OpenAI API
        </p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
            <p className='text-white mt-2 text-[14px]'>Get the image you want? 
            Share it to everyone else!</p>
            <button
              type='submit'
